...
extension_include_dirs = [
    ".",
    "/opt/folly/include",
    "/opt/fbthrift/include",
    "/opt/fizz/include",
    "/opt/wangle/include",
    "/opt/fmt/include",
    "/src/openr/_build/openr",
    "/src/fbthrift",
    "/src/folly",
    "/src/openr/openr-thrift",
    "/src/openr/fb303-thrift",
    "/src/openr/neteng-thrift",
]
...
extensions = [
    Extension(
        "openr.thrift.OpenrCtrlCpp.clients",
        [
            "/src/openr/openr-thrift/openr/if/gen-py3/openr/thrift/OpenrCtrlCpp/clients.cpp",
    ...
    Extension(
        "openr.thrift.OpenrCtrl.clients",
        [
            "/src/openr/openr-thrift/openr/if/gen-py3/openr/thrift/OpenrCtrl/clients.cpp",
    ...
    Extension(
        "openr.thrift.Platform.clients",
        [
            "/src/openr/openr-thrift/openr/if/gen-py3/openr/thrift/Platform/clients.cpp",
...
for root, _dirs, files in os.walk("/src/openr/openr-thrift"):
    for f in files:
        if f.endswith(".pyx"):
            pyx_file = os.path.join(root, f)
            module = (
                pyx_file.replace("/src/openr/openr-thrift/openr/if/gen-py3/", "")
                .replace(".pyx", "")
                .replace("/", ".")
            )
